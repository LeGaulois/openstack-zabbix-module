...
(function() {
  ...
  describe('Launch Instance Zabbix Step', function() {
    ...
    describe('LaunchInstanceZabbixController', function() {
      var ctrl;
      ...
      beforeEach(inject(function($controller) {
        var model = {
          newInstanceSpec: {
            zabbix_groups: [ 'zabbix group 1' ]
          },
          zabbixGroups: [ 'zabbix group 1', 'zabbix group 2' ]
        };
        ctrl = $controller(
          'LaunchInstanceZabbixController',
          {
      ...
      it('sets table data to appropriate scoped items', function() {
        ...
        expect(ctrl.tableData.available).toEqual([ 'zabbix group 1', 'zabbix group 2' ]);
        expect(ctrl.tableData.allocated).toEqual([ 'zabbix group 1' ]);
