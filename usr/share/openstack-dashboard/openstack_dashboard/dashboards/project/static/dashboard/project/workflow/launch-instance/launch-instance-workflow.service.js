    ...
    return dashboardWorkflow({
      ...
      steps: [
        ...
        },
        {
  	    ...
  	    {
          id: 'zabbixgroups',
          title: gettext('Zabbix Groups'),
          templateUrl: basePath + 'zabbix_groups/zabbix.html',
          helpUrl: basePath + 'zabbix_groups/zabbix.help.html',
          formName: 'launchInstanceZabbixGroupsForm'
        },
        {
          id: 'zabbixtemplates',
          title: gettext('Zabbix Templates'),
          templateUrl: basePath + 'zabbix_templates/zabbix.html',
          helpUrl: basePath + 'zabbix_templates/zabbix.help.html',
          formName: 'launchInstanceZabbixTemplatesForm'
        },
        {
          id: 'networks',
